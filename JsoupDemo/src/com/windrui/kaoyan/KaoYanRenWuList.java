...
public class KaoYanRenWuList {
	...
	public static void test(){
		try {
			Document doc = Jsoup.connect("http://yz.chsi.com.cn/kyzx/kyrw/?start=0").get();
			Elements contentList=doc.select("a[href^=/kyzx/kyrw/]").select("a[target=_blank]");
